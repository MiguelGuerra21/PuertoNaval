...
public class Test0134
{
    ...
    public void test1()
    {
        ...
        assertEquals(2780, puertoSantander.alquilar(10, veleroJennifer));       
        puertoSantander.verEstadoAmarres();         
        
        //Se intenta alquilar un amarre pero no hay libres
        assertEquals(-1, puertoSantander.alquilar(3, yateMarc)); 
        puertoSantander.verEstadoAmarres();          
        ...
        assertEquals(67665, puertoSantander.alquilar(3, yateMarc));   
